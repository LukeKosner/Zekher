...
describe("TestimonyPageClient", () => {
  ...
  test("handles content without timestamps", () => {
    const testimonyWithoutTimestamps = {
      ...mockTestimony,
      content:
        "This is plain text without timestamps.\n\nThis is another paragraph."
    };

    const { container } = render(
      <TestimonyPageClient testimony={testimonyWithoutTimestamps} />
    );
  ...
  test("handles empty content gracefully", () => {
    ...
    const { container } = render(
      <TestimonyPageClient testimony={testimonyWithoutContent} />
    );
  ...
  test("renders optional metadata only when available", () => {
    ...
    const { container } = render(
      <TestimonyPageClient testimony={minimalTestimony} />
    );
