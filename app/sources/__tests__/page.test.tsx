    ...
    mockGetAllTestimonies.mockResolvedValue([
      {
        ...
        content:
          "This is a test interview content that is long enough to be included in the preview.",
  ...
  test("handles empty lexicon data", async () => {
    ...
    await waitFor(() => {
      const content = container.querySelector(
        '[data-testid="sources-page-content"]'
      );
      expect(content).toBeTruthy();
    });

    const lexiconCount = container.querySelector(
      '[data-testid="lexicon-count"]'
    );
    const testimonyCount = container.querySelector(
      '[data-testid="testimony-count"]'
    );
