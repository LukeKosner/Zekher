...
export const AIReasoningTrigger = memo(
  ({
    ...
    return (
      <CollapsibleTrigger
        className={cn(
          "flex items-center gap-2 text-muted-foreground text-sm transition-colors duration-200 ease-out hover:text-foreground",
          className
        )}
        {...props}
      >
            ...
            <div className="flex items-center gap-1">
              ...
              <div className="transition-all duration-200 ease-out">
                {isStreaming && duration === 0 ? (
                  ...
                  <p>
                    Thought for {(duration > 0 && duration) || "a moment"}{" "}
                    {duration > 1 ? "seconds" : duration === 1 ? "second" : ""}
                  </p>
                )}
              </div>
            </div>
